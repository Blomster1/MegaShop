...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => 'postgres-info', 'port' => 5432, 'dbname' => 'bases424', 'user' => 'users424', 'password' => 'p24', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/s4tabitay/VitrineBundle/Resources/config/doctrine') => 's4tabitay\\VitrineBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 's4tabitay\\VitrineBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('s4tabitayVitrineBundle' => 's4tabitay\\VitrineBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1ee415f8e891474a778e1fb550ae5f927862f6128dd53fb508104bbd58c159b5');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/s4tabitay/VitrineBundle/Resources/views'), 's4tabitayVitrine');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('671fb0481fb176a116bdcdb6122e3809fe32d4d4');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56dd8a542c47c4.59854165')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                's4tabitayVitrineBundle' => 's4tabitay\\VitrineBundle\\s4tabitayVitrineBundle',
            ...
            'database_port' => 5432,
            'database_name' => 'bases424',
            'database_user' => 'users424',
            'database_password' => 'p24',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '671fb0481fb176a116bdcdb6122e3809fe32d4d4',
            'locale' => 'en',
            ...
            'kernel.secret' => '671fb0481fb176a116bdcdb6122e3809fe32d4d4',
