...
use s4tabitay\VitrineBundle\Form\CommandeType;
...
class CommandeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $commandes = $em->getRepository('s4tabitayVitrineBundle:Commande')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('s4tabitay\VitrineBundle\Form\CommandeType', $commande);
    ...
    {
        $deleteForm = $this->createDeleteForm($commande);
        $editForm = $this->createForm('s4tabitay\VitrineBundle\Form\CommandeType', $commande);
